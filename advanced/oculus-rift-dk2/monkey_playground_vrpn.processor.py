    ...
    class Processor(blendervr.processor.getProcessor()):
        ...
        def run(self):
            ...
            try:
                ...
                obj1 = bge.logic.getCurrentScene().objects['Monkey.001']
                self.scaleObj(obj1)
        ...
        def keyboardAndMouse(self, info):
            ...
            try:
                if info['key'] == 32: # reset monkey's position if spacebar pressed
                    self.logger.debug('Reset Monkeys position')
